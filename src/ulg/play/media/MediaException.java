 ...
 * {@link ulg.play.players.AudioMediaPlayer} or {@link MediaView}.
 *
...
public final class MediaException extends RuntimeException {
     ...
     */
    public static Type errorCodeToType(int errorCode) {
        Type errorType;
     ...
     */
    public static MediaException exceptionToMediaException(Exception e) {
    ...
    public static MediaException haltException(String message) {
        return new MediaException(Type.PLAYBACK_HALTED, message);
    }

    public static MediaException getMediaException(Object source, int errorCode, String message) {
    ...
    public MediaException(Type type, Throwable t) {
        super(t);
        this.type = type;
    }

    public MediaException(Type type, String message, Throwable t) {
        super(message, t);
        this.type = type;
    }

    public MediaException(Type type, String message) {
        super(message);
        this.type = type;
    }
    /**
