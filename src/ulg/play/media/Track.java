...
public abstract class Track {
     ...
     * the <code>Song</code> contents are formatted for. For {@link AudioTrack}s
     * this will be the language spoken, for {@link SubtitleTrack}s this will be
     * the language presented in the captions. Not all <code>Song</code>s will
     * have an associated language, in which case this method will return null.
     *
     * @return the <code>Song</code>s language information or null
     * @since JavaFX 8.0
     */
     ...
     * <code>Song</code> must be unique for its source {@link Media}.
     * @return the <code>Song</code>s unique ID
     * @since JavaFX 8.0
     */
    ...
    /**
     * @return a Map containing all known metadata for this <code>Song</code>
     * @since JavaFX 8.0
     */
