...
public class MediaView extends Node {
     ...
     * {@link AudioMediaPlayer}. Equivalent to
     * <pre><code>
     * AudioMediaPlayer player; // initialization omitted
     * MediaView view = new MediaView();
     * view.setPlayer(player);
     * </code></pre>
     *
     * @param mediaPlayer the {@link AudioMediaPlayer} the playback of which is to be
     * viewed via this class.
     */
    public MediaView(AudioMediaPlayer mediaPlayer) {
        this();
        setNodeOrientation(NodeOrientation.LEFT_TO_RIGHT);
     ...
     *
     * Setting this value does not affect the status of the <code>AudioMediaPlayer</code>,
     * e.g., if the <code>AudioMediaPlayer</code> was playing prior to setting
     * <code>mediaPlayer</code> then it will continue playing.
     *
     * @see MediaException
     * @see AudioMediaPlayer
     */
    private ObjectProperty<AudioMediaPlayer> mediaPlayer;

    /**
     * Sets the <code>AudioMediaPlayer</code> whose output will be handled by this view.
     * @param value the associated <code>AudioMediaPlayer</code>.
     */
    public final void setMediaPlayer (AudioMediaPlayer value) {
        mediaPlayerProperty().set(value);
    }

    /**
     * Retrieves the <code>AudioMediaPlayer</code> whose output is being handled by
     * this view.
     * @return the associated <code>AudioMediaPlayer</code>.
     */
    public final AudioMediaPlayer getMediaPlayer() {
        return mediaPlayer == null ? null : mediaPlayer.get();
    }

    public final ObjectProperty<AudioMediaPlayer> mediaPlayerProperty() {
        if (mediaPlayer == null) {
            mediaPlayer = new ObjectPropertyBase<AudioMediaPlayer>() {
                AudioMediaPlayer oldValue = null;
    ...
    public void notifyMediaChange() {
        AudioMediaPlayer player = getMediaPlayer();
        if (player != null) {
    ...
    /**
     * Called by AudioMediaPlayer when it becomes ready
     */
