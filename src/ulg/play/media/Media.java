 ...
 * associated with a {@link ulg.play.players.AudioMediaPlayer} and that player has transitioned to
 ...
 *
 * @see ulg.play.players.AudioMediaPlayer
 * @see MediaException
 * @since JavaFX 2.0
 */
public final class Media {
    ...
    public void _updateMedia(com.sun.media.jfxmedia.Media _media) {
        try {
    ...
    public void _setError(MediaException.Type type, String message) {
