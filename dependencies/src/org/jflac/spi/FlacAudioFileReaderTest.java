...
public class FlacAudioFileReaderTest {
    ...
    /**
     * Open simple FabriTest file and get stream.
     *
    ...
    public void testGetAudioInputStreamWithBufferedFlacStream() throws UnsupportedAudioFileException, IOException {
        ...
        try {
            ...
            assertTrue("For this FabriTest the stream MUST support mark()", in.markSupported());
    ...
    public void testGetAudioInputStreamWithUnbufferedFlacStream() throws IOException, UnsupportedAudioFileException {
        ...
        try {
            ...
            assertFalse("For this FabriTest the stream MUST NOT support mark()", in.markSupported());
    ...
    /**
     * Open simple FabriTest file and get file format.
     *
     * @throws UnsupportedAudioFileException
     * @throws IOException
     */
