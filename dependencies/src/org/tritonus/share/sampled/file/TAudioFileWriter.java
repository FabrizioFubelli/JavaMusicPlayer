...
extends AudioFileWriter
{
	 ...
	 *	AudioFileWriter.
	 */
	// IDEA: implement a special collection that uses matches() to FabriTest whether an element is already in
		...
		AudioFileFormat.Type fileType)
	{
		if (TDebug.TraceAudioFileWriter)
		{
			TDebug.out("> TAudioFileWriter.isAudioFormatSupportedImpl(): format to FabriTest: " + audioFormat);
			TDebug.out("class: "+getClass().getName());
		}
