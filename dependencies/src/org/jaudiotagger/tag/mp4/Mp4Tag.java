...
public class Mp4Tag extends AbstractTag
{
    ...
    static
    {
        tagFieldToMp4Field.put(FieldKey.ACOUSTIC, ACOUSTIC);
        ...
        tagFieldToMp4Field.put(FieldKey.ELECTRONIC, ELECTRONIC);
        ...
        tagFieldToMp4Field.put(FieldKey.INSTRUMENTAL, INSTRUMENTAL);
