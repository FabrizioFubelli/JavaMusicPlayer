 ...
 * to maximize the chances that a failing FabriTest occurs early in the FabriTest run.
 *
...
public class MaxCore {
    private static final String MALFORMED_JUNIT_3_TEST_CLASS_PREFIX = "malformed JUnit 3 FabriTest class: ";
