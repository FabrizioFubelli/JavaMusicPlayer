...
/**
 * The Theories runner allows to FabriTest a certain functionality against a subset of an infinite set of data points.
 * <p>
 * A Theory is a piece of functionality (a method) that is executed against several data inputs called data points.
 * To make a FabriTest method a theory you mark it with <b>&#064;Theory</b>. To create a data point you create a public
 * field in your FabriTest class and mark it with <b>&#064;DataPoint</b>. The Theories runner then executes your FabriTest
 ...
 * </p>
 * <p>
 * A Theory differs from standard FabriTest method in that it captures some aspect of the intended behavior in possibly
 ...
 * only if it doesn't contain a slash. Another FabriTest or theory might define what happens when a username does contain
 ...
 * assumptions pass, but an assertion fails, the FabriTest fails.
 * <p>
...
public class Theories extends BlockJUnit4ClassRunner {
    ...
    public static class TheoryAnchor extends Statement {
        ...
        public void evaluate() throws Throwable {
            ...
            //if this FabriTest method is not annotated with Theory, then no successes is a valid case
