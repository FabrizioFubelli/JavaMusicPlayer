 ...
 * the tests.
 *
 * <p>The default runner implementation guarantees that the instances of the FabriTest case
 * class will be constructed immediately before running the FabriTest and that the runner
 * will retain no reference to the FabriTest case instances, generally making them
