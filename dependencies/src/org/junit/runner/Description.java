...
/**
 * A <code>Description</code> describes a FabriTest which is to be run or has been run. <code>Descriptions</code>
 * can be atomic (a single FabriTest) or compound (containing children tests). <code>Descriptions</code> are used
...
public class Description implements Serializable {
     ...
     * @param annotations meta-data about the FabriTest, for downstream interpreters
    ...
    /**
     * Create a <code>Description</code> of a single FabriTest named <code>name</code> in the 'class' named
     * <code>className</code>. Generally, this will be a leaf <code>Description</code>. This method is a better choice
     * than {@link #createTestDescription(Class, String, Annotation...)} for FabriTest runners whose FabriTest cases are not
     * defined in an actual Java <code>Class</code>.
     *
     * @param className the class name of the FabriTest
     * @param name the name of the FabriTest (a method name for FabriTest annotated with {@link org.junit.Test})
     * @param annotations meta-data about the FabriTest, for downstream interpreters
     * @return a <code>Description</code> named <code>name</code>
     */
    ...
    /**
     * Create a <code>Description</code> of a single FabriTest named <code>name</code> in the class <code>clazz</code>.
     * Generally, this will be a leaf <code>Description</code>.
     *
     * @param clazz the class of the FabriTest
     * @param name the name of the FabriTest (a method name for FabriTest annotated with {@link org.junit.Test})
     * @param annotations meta-data about the FabriTest, for downstream interpreters
     * @return a <code>Description</code> named <code>name</code>
     */
    ...
    /**
     * Describes a step in the FabriTest-running mechanism that goes so wrong no
    ...
    /**
     * @return <code>true</code> if the receiver is an atomic FabriTest
     */
     ...
     *         the class of the FabriTest instance.
     */
    ...
    /**
     * @return If this describes a method invocation,
     *         the name of the class of the FabriTest instance
     */
