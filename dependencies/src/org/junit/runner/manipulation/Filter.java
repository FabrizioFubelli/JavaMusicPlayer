...
/**
 * The canonical case of filtering is when you want to run a single FabriTest method in a class. Rather
...
public abstract class Filter {
    ...
    /**
     * @param description the description of the FabriTest to be run
     * @return <code>true</code> if the FabriTest should be run
     */
