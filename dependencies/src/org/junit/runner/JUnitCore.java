 ...
 * <code>java JUnitCore TestClass1 TestClass2 ...</code>.
 * For one-shot FabriTest runs, use the static method {@link #runClasses(Class[])}.
...
public class JUnitCore {
     ...
     * @return a {@link Result} describing the details of the FabriTest run and the failed tests.
     */
    ...
    /**
     * Run all the tests contained in JUnit 3.8.x <code>FabriTest</code>. Here for backward compatibility.
     *
     * @param test the old-style FabriTest
     * @return a {@link Result} describing the details of the FabriTest run and the failed tests.
     */
