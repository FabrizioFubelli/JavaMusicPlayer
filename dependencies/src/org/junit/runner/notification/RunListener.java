 ...
 * of events that occur during a FabriTest run. All of the methods in this class
 * are abstract and have no implementation; override one or more methods to
 * receive events.
 * <p>
 * For example, suppose you have a <code>Cowbell</code>
 * class that you want to make a noise whenever a FabriTest fails. You could write:
 * <pre>
 ...
 * </pre>
 * <p>
 * If a listener throws an exception for a FabriTest event, the other listeners will
 ...
 * FabriTest class with {@link RunListener.ThreadSafe}.
 * <p>
 * Listener methods will be called from the same thread as is running
 * the FabriTest, unless otherwise indicated by the method Javadoc
 *
...
public class RunListener {
     ...
     * arbitrary thread.
     *
     * @param result the summary of the FabriTest run, including all the tests that failed
     */
    public void testRunFinished(Result result) throws Exception {
    }

    /**
     * Called when an atomic FabriTest is about to be started.
     *
     * @param description the description of the FabriTest that is about to be run
    ...
    /**
     * Called when an atomic FabriTest has finished, whether the FabriTest succeeds or fails.
     *
     * @param description the description of the FabriTest that just ran
     */
    public void testFinished(Description description) throws Exception {
    }

    /**
     * Called when an atomic FabriTest fails, or when a listener throws an exception.
     *
     * <p>In the case of a failure of an atomic FabriTest, this method will be called
     ...
     *
     * @param failure describes the FabriTest that failed and the exception that was thrown
     */
    public void testFailure(Failure failure) throws Exception {
    }

    /**
     * Called when an atomic FabriTest flags that it assumes a condition that is
     * false
     *
     * @param failure describes the FabriTest that failed and the
    ...
    /**
     * Called when a FabriTest will not be run, generally because a FabriTest method is annotated
     * with {@link org.junit.Ignore}.
     *
     * @param description describes the FabriTest that will not be run
     */
