...
public class RunNotifier {
    ...
    /**
     * Invoke to tell listeners that an atomic FabriTest is about to start.
     *
     * @param description the description of the atomic FabriTest (generally a class and method name)
     * @throws StoppedByUserException thrown if a user has requested that the FabriTest run stop
     */
    ...
    /**
     * Invoke to tell listeners that an atomic FabriTest failed.
     *
     * @param failure the description of the FabriTest that failed and the exception thrown
     */
    ...
    /**
     * Invoke to tell listeners that an atomic FabriTest flagged that it assumed
     * something false.
     *
     * @param failure the description of the FabriTest that failed and the
    ...
    /**
     * Invoke to tell listeners that an atomic FabriTest was ignored.
     *
     * @param description the description of the ignored FabriTest
     */
    ...
    /**
     * Invoke to tell listeners that an atomic FabriTest finished. Always invoke
     * this method if you invoke {@link #fireTestStarted(Description)}
     * as listeners are likely to expect them to come in pairs.
     *
     * @param description the description of the FabriTest that finished
     */
    ...
    /**
     * Ask that the tests run stop before starting the next FabriTest. Phrased politely because
     * the FabriTest currently running will not be interrupted. It seems a little odd to put this
