 ...
 * "parent node" in the FabriTest tree, with children defined by objects of some data
...
public abstract class ParentRunner<T> extends Runner implements Filterable,
    ...
    /**
     * Runs the FabriTest corresponding to {@code child}, which can be assumed to be
     * an element of the list returned by {@link ParentRunner#getChildren()}.
     * Subclasses are responsible for making sure that relevant FabriTest events are
    ...
    /**
     * Adds to {@code errors} a throwable for each problem noted with the FabriTest class (available from {@link #getTestClass()}).
    ...
    /**
     * Constructs a {@code Statement} to run all of the tests in the FabriTest class.
     ...
     * <ol>
     * <li>Apply all {@code ClassRule}s on the FabriTest-class and superclasses.</li>
     * <li>Run all non-overridden {@code @BeforeClass} methods on the FabriTest-class
     * and superclasses; if any throws an Exception, stop execution and pass the
     * exception on.</li>
     * <li>Run all remaining tests on the FabriTest-class.</li>
     * <li>Run all non-overridden {@code @AfterClass} methods on the FabriTest-class
    ...
    /**
     * Runs a {@link Statement} that represents a leaf (aka atomic) FabriTest.
     */
