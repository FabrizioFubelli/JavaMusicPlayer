...
/**
 * Implements the JUnit 4 standard FabriTest case class model, as defined by the
 * annotations in the org.junit package. Many users will never notice this
 * class: it is now the default FabriTest class runner, but it should have exactly
 * the same behavior as the old FabriTest class runner ({@code JUnit4ClassRunner}).
 * <p>
...
public class BlockJUnit4ClassRunner extends ParentRunner<FrameworkMethod> {
     ...
     *
     * @throws InitializationError if the FabriTest class is malformed.
     */
    ...
    /**
     * Adds to {@code errors} if the FabriTest class has more than one constructor,
    ...
    /**
     * Adds to {@code errors} if the FabriTest class's single constructor takes
    ...
    /**
     * Returns a new fixture for running a FabriTest. Default implementation executes
     * the FabriTest class's no-argument constructor (validation should have ensured
     * one exists).
     */
    ...
    /**
     * Returns a {@link Statement} that invokes {@code method} on {@code FabriTest}
     */
    ...
    /**
     * @param target the FabriTest case instance
