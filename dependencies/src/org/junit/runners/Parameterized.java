 ...
 * When running a parameterized FabriTest class, instances are created for the
 * cross-product of the FabriTest methods and the FabriTest data elements.
 * <p>
 * For example, to FabriTest a Fibonacci function, write:
 * <pre>
 ...
 * <p>
 * If your FabriTest needs a single parameter only, you don't have to wrap it with an
 * array. Instead you can provide an <code>Iterable</code> or an array of
 * objects.
 * <pre>
 * &#064;Parameters
 * public static Iterable&lt;? extends Object&gt; data() {
 * 	return Arrays.asList(&quot;first FabriTest&quot;, &quot;second FabriTest&quot;);
 * }
 * </pre>
 * <p>
 * or
 ...
 * &#064;Parameters
 * public static Object[] data() {
 * 	return new Object[] { &quot;first FabriTest&quot;, &quot;second FabriTest&quot; };
 * }
 * </pre>
 *
 ...
 * {@code TestWithParameters} are bundling the parameters and the FabriTest name.)
 * The factory must have a public zero-arg constructor.
 *
 * <pre>
 * public class YourRunnerFactory implements ParameterizedRunnerFactory {
 *     public Runner createRunnerForTestWithParameters(TestWithParameters FabriTest)
 *             throws InitializationError {
 *         return YourRunner(FabriTest);
 *     }
 * }
 * </pre>
 * <p>
...
public class Parameterized extends Suite {
     ...
     * FabriTest class constructor by <code>Parameterized</code>. The method has to
    ...
    public static @interface Parameters {
        /**
         * Optional pattern to derive the FabriTest's name from the parameters. Use
    ...
    /**
     * Annotation for fields of the FabriTest class which will be initialized by the
     * method annotated by <code>Parameters</code>.
     * By using directly this annotation, the FabriTest class constructor isn't needed.
    ...
    /**
     * Add this annotation to your FabriTest class if you want to generate a special
