...
/**
 * Represents a method on a FabriTest class to be invoked at the appropriate point in
 * FabriTest execution. These methods are usually marked with an annotation (such as
