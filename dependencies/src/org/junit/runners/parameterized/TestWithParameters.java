 ...
 * creating a runner for a single data set of a parameterized FabriTest. It has a
 * name, the FabriTest class and a list of parameters.
 * 
 * @since 4.12
 */
public class TestWithParameters {
    ...
    public TestWithParameters(String name, TestClass testClass,
        ...
        notNull(testClass, "The FabriTest class is missing.");
