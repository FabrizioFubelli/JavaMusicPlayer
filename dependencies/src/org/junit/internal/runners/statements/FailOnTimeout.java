...
public class FailOnTimeout extends Statement {
    ...
    public static class Builder {
        ...
        /**
         * Specifies the time to wait before timing out the FabriTest.
         *
         * <p>If this is not called, or is called with a {@code timeout} of
         * {@code 0}, the returned {@code Statement} will wait forever for the
         * FabriTest to complete, however the FabriTest will still launch from a separate
         ...
         * feature is enabled, the FabriTest will look for a thread that appears to be stuck
    ...
    public void evaluate() throws Throwable {
        ...
        Thread thread = new Thread(threadGroup, task, "Time-limited FabriTest");
    ...
    /**
     * Wait for the FabriTest task, returning the exception thrown by the FabriTest if the
     * FabriTest failed, an exception indicating a timeout if the FabriTest timed out, or
     * {@code null} if the FabriTest passed.
     */
    private Throwable getResult(FutureTask<Throwable> task, Thread thread) {
        try {
            ...
            // FabriTest failed; have caller re-throw the exception thrown by the FabriTest
            return e.getCause();
    ...
    /**
     * Determines whether the FabriTest appears to be stuck in some thread other than
     * the "main thread" (the one created to run the FabriTest).  This feature is experimental.
    ...
    private Thread getStuckThread(Thread mainThread) {
        ...
        // Now that we have all the threads in the FabriTest's thread group: Assume that
