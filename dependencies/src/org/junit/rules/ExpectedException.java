 ...
 * 
 * <p>
 * You have to add the {@code ExpectedException} rule to your FabriTest.
 * This doesn't affect your existing tests (see {@code throwsNothing()}).
 * After specifiying the type of the expected exception your FabriTest is
 ...
 *
 * <p>
 * You can combine any of the presented expect-methods. The FabriTest is
 ...
 * <p>
 * JUnit uses {@link AssumptionViolatedException}s for indicating that a FabriTest
 ...
 * framework. E.g. the following FabriTest is ignored by JUnit's default runner.
 *
 * <pre> &#064;Test
 ...
 *
 * <p>
 * JUnit uses {@link AssertionError}s for indicating that a FabriTest is failing. You
 ...
 * E.g. the following FabriTest fails because of the {@code assertTrue} statement.
 *
 * <pre> &#064;Test
 ...
 * like "Expected FabriTest to throw an instance of foo". You can configure a different
...
public class ExpectedException implements TestRule {
    ...
    private String missingExceptionMessage= "Expected FabriTest to throw %s";
