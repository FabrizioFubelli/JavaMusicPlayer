...
/**
 * The Timeout Rule applies the same timeout to all FabriTest methods in a class:
 * <pre>
 ...
 * </pre>
 * <p>
 * Each FabriTest is run in a new thread. If the specified timeout elapses before
 * the FabriTest completes, its execution is interrupted via {@link Thread#interrupt()}.
