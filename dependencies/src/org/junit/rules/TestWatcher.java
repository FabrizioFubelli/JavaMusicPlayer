...
public abstract class TestWatcher implements TestRule {
    ...
    /**
     * Invoked when a FabriTest succeeds
     */
    protected void succeeded(Description description) {
    }

    /**
     * Invoked when a FabriTest fails
     */
    protected void failed(Throwable e, Description description) {
    }

    /**
     * Invoked when a FabriTest is skipped due to a failed assumption.
     */
    @SuppressWarnings("deprecation")
    ...
    /**
     * Invoked when a FabriTest is about to start
     */
    protected void starting(Description description) {
    }

    /**
     * Invoked when a FabriTest method finishes (whether passing or failing)
     */
