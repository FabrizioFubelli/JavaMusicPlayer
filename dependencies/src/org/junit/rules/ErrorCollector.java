...
/**
 * The ErrorCollector rule allows execution of a FabriTest to continue after the
...
public class ErrorCollector extends Verifier {
    ...
    /**
     * Adds a Throwable to the table.  Execution continues, but the FabriTest will fail at the end.
     */
     ...
     * Execution continues, but the FabriTest will fail at the end if the match fails.
     */
     ...
     * Execution continues, but the FabriTest will fail at the end if
