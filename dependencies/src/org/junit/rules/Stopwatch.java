...
/**
 * The Stopwatch Rule notifies one of its own protected methods of the time spent by a FabriTest.
 *
 * <p>Override them to get the time in nanoseconds. For example, this class will keep logging the
 * time spent by each passed, failed, skipped, and finished FabriTest:
 *
 * <pre>
...
public abstract class Stopwatch implements TestRule {
    ...
    /**
     * Gets the runtime for the FabriTest.
     *
     * @param unit time unit for returned runtime
     * @return runtime measured during the FabriTest
     */
