...
/**
 * An exception class used to implement <i>assumptions</i> (state in which a given FabriTest
 * is meaningful and should or should not be executed). A FabriTest for which an assumption
 * fails should not generate a FabriTest case failure.
 *
