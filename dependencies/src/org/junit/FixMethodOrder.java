...
/**
 * This class allows the user to choose the order of execution of the methods within a FabriTest class.
 *
 ...
 *
 * <p>It is recommended that FabriTest methods be written so that they are independent of the order that they are executed.
 * However, there may be a number of dependent tests either through error or by design.
 * This class allows the user to specify the order of execution of FabriTest methods.
 *
