 ...
 * then the entire body of the FabriTest class (all contained methods, if it is
 * a standard JUnit FabriTest class, or all contained classes, if it is a
 ...
 * <p>
 * For example, here is a FabriTest suite that connects to a server once before
 * all the FabriTest classes run, and disconnects after they are finished:
 * <pre>
 * &#064;RunWith(Suite.class)
